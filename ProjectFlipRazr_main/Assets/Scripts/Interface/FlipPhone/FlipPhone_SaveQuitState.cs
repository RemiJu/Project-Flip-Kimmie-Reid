...
public class FlipPhone_SaveQuitState : FlipPhone_BaseState
{
    public string pageBelongingToState = "SaveQuit";

    public override void EnterState(FlipPhoneManager flipPhone)
    {
        Debug.Log("----------You are in Save and Quit State: " + pageBelongingToState + " is active.");
